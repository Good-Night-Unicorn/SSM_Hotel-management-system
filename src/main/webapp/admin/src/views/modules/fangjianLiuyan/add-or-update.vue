    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="fangjianLiuyanText">
                        <el-input type="textarea"  :readonly="ro.fangjianLiuyanText" v-model="ruleForm.fangjianLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.fangjianLiuyanText" label="留言内容" prop="fangjianLiuyanText">
