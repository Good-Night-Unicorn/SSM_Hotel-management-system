    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='fangjian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="所在区域" prop="fangjianAddress">
                        <el-input v-model="fangjianForm.fangjianAddress"
                                  placeholder="所在区域" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="所在区域" prop="fangjianAddress">
                ...
                <el-col :span="12"  v-if="sessionTable !='fangjian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="房间状态" prop="statusValue">
                        <el-input v-model="fangjianForm.statusValue"
                                  placeholder="房间状态" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="房间状态" prop="statusValue">
            ...
            <input id="fangjianId" name="fangjianId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="预定时间" prop="fangjianyudingTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:ss:mm"
                                v-model="ruleForm.fangjianyudingTime"
                                type="datetime"
                                placeholder="预定时间">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.fangjianyudingTime" label="预定时间" prop="fangjianyudingTime">
                            <span v-html="ruleForm.fangjianyudingTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="预定状态" prop="fangjianyudingTypes">
                        <el-select v-model="ruleForm.fangjianyudingTypes" :disabled="ro.fangjianyudingTypes" placeholder="请选择预定状态">
                            <el-option
                                v-for="(item,index) in fangjianyudingTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="预定状态" prop="fangjianyudingValue">
                        <el-input v-model="ruleForm.fangjianyudingValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    fangjianId: false,
                    fangjianyudingTime: false,
                    updateTime: false,
                    fangjianyudingTypes: false,
                },
                ruleForm: {
                    yonghuId: '',
                    fangjianId: '',
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=fangjianyuding_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.fangjianyudingTypesOptions = data.data.list;
                    }
                });
