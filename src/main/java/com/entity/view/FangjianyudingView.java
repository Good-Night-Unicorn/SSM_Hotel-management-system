...
public class FangjianyudingView extends FangjianyudingEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 预定状态的值
		*/
		private String fangjianyudingValue;
	...
	public FangjianyudingView(FangjianyudingEntity fangjianyudingEntity) {
		try {
			...
			* 获取： 预定状态的值
			*/
			public String getFangjianyudingValue() {
				return fangjianyudingValue;
			}
			/**
			* 设置： 预定状态的值
			*/
			public void setFangjianyudingValue(String fangjianyudingValue) {
				this.fangjianyudingValue = fangjianyudingValue;
			}
